...
{
    public class RcfEntity : BaseEntity
    {
        public RcfEntity()
        {
            //Empty Constructor
        ...
        public RcfEntity(BaseEntity baseEntity, string __flightNo, int __pcsRCF,
            double __weightRCF, string __shipmentIndicatorRCF, DateTime __arrCargoDate, DateTime __arrFlightMasterDate)
        {
