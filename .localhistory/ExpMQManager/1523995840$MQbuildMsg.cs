        ...
        public void getQueueList(ListBox listbox)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    strSql = @" SELECT iid, MsgType, subMsgType, MID, HID, RefID, FlightSeq, ResendYN, EDIAddressBook, CustomerId, MsgBody_SITAfreeMSG, MsgAddress_SITAfreeMSG from EDI_Msg_Queue where Status = 'W' and createddate >= '2018-4-17' and Msgtype <> 'Email' ";
                            ...
                            if (msgReturn != "")
                            {
                                ...
                                */
                                ...
                                foreach (string msg in arrMsg)
                                {
                                    ...
                                    if (!isLive)
                                        baseMessage.msgDestAddrEmail = "ckim@wfs.aero;Nigeena.Popal@wfs.aero;mserzo@wfs.aero;mivanova@wfs.aero;czhao@wfs.aero;cpark@wfs.aero";
