...
namespace ExpMQManager.BLL
{
    public class GenerateFWB : GenerateBase
    {
        ...
        public string buildUpFWB(FwbEntity msgEntity, string msgType, string subType)
        {
            ...
            //NFY
            if(
                !string.IsNullOrEmpty(msgEntity.nfyNm) && !string.IsNullOrEmpty(msgEntity.nfyAddr) && !string.IsNullOrEmpty(msgEntity.nfyPlace) && !string.IsNullOrEmpty(msgEntity.nfyCountry)
                )
