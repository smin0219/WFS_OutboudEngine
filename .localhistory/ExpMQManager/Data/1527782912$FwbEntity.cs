...
namespace ExpMQManager.Data
{
    public class FwbEntity : BaseEntity
    {
        ...
        public FwbEntity(BaseEntity baseEntity, string __shipperNm, string __shipperAddr, string __shipperAddr2,
            string __shipperCity, string __shipperState, string __shipperCountry, string __shipperZip, string __shipperAddrTel, string __shipperContact,
            string __cneeNm, string __cneeAddr, string __cneeCity, string __cneeProv, string __cneeCountry, string __cneeZip, string __cneeAddrTel, string __cneeContact,
