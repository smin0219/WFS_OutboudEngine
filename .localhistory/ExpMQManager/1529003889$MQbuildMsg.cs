        ...
        public void getQueueList(ListBox listbox)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    strSql = @" SELECT iid, MsgType, subMsgType, MID, HID, RefID, FlightSeq, ResendYN, EDIAddressBook, CustomerId, MsgBody_SITAfreeMSG, MsgAddress_SITAfreeMSG from EDI_Msg_Queue where Status = 'W' and createddate >= CONVERT (date, GETDATE()) and (Msgtype <> 'Email' or SubMsgType = 'TTN')  ";
