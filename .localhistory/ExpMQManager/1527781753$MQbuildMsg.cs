    ...
    public class MQbuildMsg
    {
        ...
        public void getQueueList(ListBox listbox)
        {
            ...
            try
            {
                ...
                {
                    strSql = @" select iid, MsgType, subMsgType, MID, HID, RefID, FlightSeq, ResendYN, EDIAddressBook, CustomerId, MsgBody_SITAfreeMSG, MsgAddress_SITAfreeMSG from EDI_Msg_Queue where iid in (1115031)";
