        ...
        public void getQueueList(ListBox listbox)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    //            from EDI_Msg_Queue where iid in (4345335)";

                    strSql = @" SELECT iid, MsgType, subMsgType, MID, HID, RefID, FlightSeq, ResendYN, EDIAddressBook, CustomerId, MsgBody_SITAfreeMSG, MsgAddress_SITAfreeMSG from EDI_Msg_Queue where Status = 'W' and createddate >= '2018-5-22' and (Msgtype <> 'Email' or SubMsgType = 'TTN')  ";
